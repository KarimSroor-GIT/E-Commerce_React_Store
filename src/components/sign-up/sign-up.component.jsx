...
handleSubmit = async event =>{
    ...
    if ( password !== confirmPassword ){
      alert('password and confirm password feilds do not match please check related feilds');
      return;
    }
...
return (
  ...
  <FormInput type='password' name='password' value={password} label= 'New Password' 
  onChange={this.handleChange} required/>
